...
namespace GameWebApi
{
    public class FileRepository : IRepository
    {
        ...
        string path2 = Path.Combine(Directory.GetCurrentDirectory(), "game-prod.txt");
        ...
        public Task<Player[]> GetBetweenLvl(int min, int max)
        {
            throw new NotImplementedException();
        }

        public Task<Player[]> GetScoreBelow(int lvl)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<Player> UpdatePlayerScore(Guid Id, Player player)
        {
            throw new NotImplementedException();
        }
    }
